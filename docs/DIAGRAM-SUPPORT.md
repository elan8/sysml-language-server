...
- `interconnection-view`
  Useful for parts, ports, and connectors. It now has basic CI export coverage and improved root selection, port readability, connector routing, and clearer no-connector messaging, but still needs stronger routing/layout quality on dense real-world models before it should be release-enabled by default.
- `action-flow-view`
