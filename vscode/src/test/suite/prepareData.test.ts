...
describe("prepareDataForView", () => {
    ...
    it("returns null/undefined for null input", () => {
        assert.strictEqual(prepareDataForView(null, "elk"), null);
    });

    it("ibd view produces parts and connectors", () => {
        const data = createMockData();
        const result = prepareDataForView(data, "ibd");
    ...
    it("package view produces nodes", () => {
        const data = createMockData();
        const result = prepareDataForView(data, "package");
    ...
    it("sequence view produces sequenceDiagrams", () => {
        const data = createMockData();
        const result = prepareDataForView(data, "sequence");
    ...
    it("usecase view produces actors and useCases", () => {
        const data = createMockData();
        const result = prepareDataForView(data, "usecase");
    ...
    it("handles empty elements", () => {
        ...
        const result = prepareDataForView(data, "elk");
